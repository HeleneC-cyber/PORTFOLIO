      ...
      <main className="mt-[50px] text-dark ">
        <section className="main-container mb-[50px] md:mb-[100px] ">
          ...
          <div className="font-primary text-xs md:text-sm flex items-start gap-[35px] mt-[20px] md:mt-[50px]">
            {/* IMAGE FOR DESKTOP */}
            <div className="hidden w-[380px] md:block md:ml-[20px] relative -z-2">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-start gap-[15px]">
                {/* IMAGE FOR MOBILE */}
                <img src={WomanTeaMobile} alt="Femme tenant une énorme tasse de thé" className="block md:hidden w-[170px] " />
        ...
        <section className="full-container py-[70px] lg:py-[100px] bg-light mt-[100px] relative">
          <Wave
            fill="#FEF4EB"
            paused={false}
          ...
          <div className="main-container">
            ...
            <div className="hidden md:block md:mb-[40px] relative z-2 mr-[40px]">
