...
const Home = () => {
  return (
    <div className="main-container">
      <main className="font-primary text-dark relative min-h-screen flex flex-col items-center mt-[80px]">
        <motion.h1 className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 leading-[1.2] text-2xl w-[420px] max-w-[95%] md:w-[720px] after:size-[20px] md:after:size-[30px] after:bg-red after:rounded-full after:content-[''] after:inline-block after:ml-[10px] md:text-4xl"
          initial={{ opacity: 0 }}
          animate={{
            top: 80,
            opacity: 1,
        ...
        <div className="relative w-fit mt-[230px] mx-[30px]">
          <motion.img src={illustrationHome} alt="Femme devant un ordinateur avec un lapin et des plantes" className="w-[670px] max-w-[97%]"
            initial={{ opacity: 0 }}
            animate={{
              opacity: 1,
            }}
          ...
          />
          <motion.img src={plantL} alt="Feuille allongée de couleur sable" className="absolute w-[180px] -z-1 max-w-[23%] bottom-[25px] -left-[20px] md:max-w-full md:bottom-[35px] md:-left-[40px]"
          ...
          />
          <motion.img src={plantR1} alt="Feuille de monsterra en rouge" className="absolute -z-1 w-[215px] bottom-[60%] right-[30px] md:bottom-[60%] md:right-[30px] max-w-[23%] md:max-w-full"
            initial={{ rotate: 0, opacity: 0 }}
            animate={{
              rotate: [5, -5],
              opacity: 1,
          ...
          />
          <motion.img src={plantR2} alt="Feuille allongée de couleur jaune" className="absolute bottom-[20px] right-0 w-[230px] -z-1 max-w-[30%] md:max-w-full md:-right-[20px]"
            initial={{ rotate: 0, opacity: 0 }}
            animate={{
              rotate: [6, -4],
              opacity: 1,
        ...
        <motion.ul className="block md:hidden px-[30px] w-full mt-[40px] mb-[80px]">
